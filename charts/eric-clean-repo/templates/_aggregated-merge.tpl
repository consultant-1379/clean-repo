...
*/ -}}
{{- define "eric-clean-repo.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-clean-repo.mergeAnnotations" -}}
  {{- include "eric-clean-repo.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}
{{- define "eric-clean-repo.mergeLabels" -}}
  {{- include "eric-clean-repo.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
